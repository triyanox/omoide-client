...
const endPoint = config.endpoint + '/v1/posts/allposts/likes'
  ...
  return (
    <Fragment>
      <div className="items-cernter my-16 flex flex-col justify-start gap-4 px-8 md:px-24 xl:px-20">
        <h1 className="text-xl font-bold md:text-2xl">Most Liked Posts</h1>
        <p className="text-md md:text-lg">Here are the most liked posts</p>
      </div>
      {data && (
