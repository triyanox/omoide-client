...
const endPoint = config.endpoint + '/v1/posts/allposts/latest'
  ...
  return (
    <Fragment>
      <div className="items-cernter my-16 flex flex-col justify-start gap-4 px-8 md:px-24 xl:px-20">
        <h1 className="text-xl font-bold md:text-2xl">Latest Memories</h1>
        <p className="text-md md:text-lg">
          Here are the latest memories posted by the community.
        </p>
      </div>
      {data && (
